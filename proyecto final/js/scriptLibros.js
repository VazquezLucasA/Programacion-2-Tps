...
btnEdit.addEventListener("click" , actualizar)
...
function mostrarTodosLibros(){
    ...
    .then(function (respuesta) {
        ...
        containerLibros.innerHTML +=  '<button class="frm__btn" onclick="eliminarLibro('+element.id+')">ELIMINAR</button>' + '<button class="frm__btn" onclick="modificar('+element.id+')">EDITAR</button>' +  element.titulo + ", " +  element.autor + ". "  + "<br>" }); 
    })
}
